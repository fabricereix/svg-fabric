...
attributes element@(Circle _ _ _ _ _ _ _) =
  ...
  ++ map (\v->("stroke",v)) (maybeToList $ Circle.stroke element)

attributes element@(Rect _ _ _ _ _ _ _) =
  ...
  ++ map (\v->("stroke",v)) (maybeToList $ Rect.stroke element)
